...
public class ThreadMain {
	private static Scanner input = new Scanner (System.in); //creazione dello scanner che ci permette di prendere in input i dati
	private static int cassa; //creazione variabile intera cassa , statica perchè deve essere globale nella classe
